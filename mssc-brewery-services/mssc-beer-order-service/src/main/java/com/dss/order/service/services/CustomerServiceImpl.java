...
import com.dss.order.service.web.mappers.CustomerMapper;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerPagedList listCustomers(Pageable pageable) {
        ...
        return new CustomerPagedList(customerPage
                ...
                PageRequest.of(customerPage.getPageable().getPageNumber(), customerPage.getPageable().getPageSize()), customerPage.getTotalElements());
    }
}
